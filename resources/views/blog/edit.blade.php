...
<section class="w3-padding">
    ...
    <form method="post" action="{{ env('APP_URL') }}/console/blog/edit/{{$blog->id}}" novalidate class="w3-margin-bottom">
        ...
        <div class="w3-margin-bottom">
            ...
            <textarea name="status" id="status" required>{{old('status', $blog->status)}}</textarea>
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="url" name="url" id="url" value="{{old('url', $blog->url)}}">
