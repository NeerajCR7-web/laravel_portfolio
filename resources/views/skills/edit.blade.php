...
<section class="w3-padding">
    ...
    <form method="post" action="{{ env('APP_URL') }}/console/skills/edit/{{$skill->id}}" novalidate class="w3-margin-bottom">
    ...
    <a href="{{ env('APP_URL') }}/console/skills/list">Back to Skill List</a>
