    ...
    @foreach ($projects as $project)
        ...
        <div class="w3-card w3-margin">
            ...
            <div class="w3-container w3-padding">
                ...
                @if ($project->url)
                    View Project: <a href="{{ env('APP_URL') }}/console/projects/list">{{$project->url}}</a>
                @endif
                ...
                <a href="{{ env('APP_URL') }}/console/projects/list" class="w3-button w3-green">View Project Details</a>
