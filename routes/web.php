...
Route::get('/console/blog/list', [BlogController::class, 'list'])->middleware('auth');
Route::get('/console/blog/add', [BlogController::class, 'addForm'])->middleware('auth');
Route::post('/console/blog/add', [BlogController::class, 'add'])->middleware('auth');
Route::get('/console/blog/edit/{blog:id}', [BlogController::class, 'editForm'])->where('blog', '[0-9]+')->middleware('auth');
Route::post('/console/blog/edit/{blog:id}', [BlogController::class, 'edit'])->where('blog', '[0-9]+')->middleware('auth');
Route::get('/console/blog/delete/{blog:id}', [BlogController::class, 'delete'])->where('blog', '[0-9]+')->middleware('auth');
